...
import io.github.yeyuhl.novel.core.interceptor.AuthInterceptor;
import io.github.yeyuhl.novel.core.interceptor.FileInterceptor;
import io.github.yeyuhl.novel.core.interceptor.FlowLimitInterceptor;
import io.github.yeyuhl.novel.core.interceptor.TokenParseInterceptor;
...
/**
 * Spring Web Mvc配置类
 * 不能加@EnableWebMvc注解，否则会导致jackson的全局配置失效
 * 因为@EnableWebMvc注解会导致WebMvcAutoConfiguration自动配置失效
 *
 * @author yeyuhl
 * @date 2023/5/17
 */
