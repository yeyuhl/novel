package io.github.yeyuhl.novel.controller.author;
...
import io.github.yeyuhl.novel.dto.resp.ChapterContentRespDto;
import io.github.yeyuhl.novel.service.AuthorService;
...
public class AuthorController {
    ...
    public RestResp<Void> deleteBookChapter(@Parameter(description = "章节ID") @PathVariable("chapterId") Long chapterId) {
    ...
    public RestResp<ChapterContentRespDto> getBookChapter(@Parameter(description = "章节ID") @PathVariable("chapterId") Long chapterId) {
    ...
    public RestResp<Void> updateBookChapter(@Parameter(description = "章节ID")
